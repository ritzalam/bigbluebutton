...
case class UserVO(id: IntUserId, extId: ExtUserId, name: Name, roles: Set[String],
...
case class User2(id: IntUserId, extId: ExtUserId, name: Name, sessionId: SessionId, roles: Set[String],
...
case class Voice2(id: String, webId: String, callId: CallerId, phoningIn: Boolean,
