package org.bigbluebutton.lib.user.services {
    ...
    public var logger:ILogger;
      ...
      logger.debug("UsersMessageSender::kickUser() -- Sending [participants.kickUser] message to server.. with message [userID:" + userID + "]");
      ...
      logger.debug("UsersMessageSender::queryForParticipants() -- Sending [participants.getParticipants] message to server");
      ...
      logger.debug("UsersMessageSender::assignPresenter() -- Sending [participants.assignPresenter] message to server with message " + "[newPresenterID:" + userid + ", newPresenterName:" + name + ", assignedBy:" + assignedBy + "]");
			var message:Object = new Object();
      ...
      logger.debug("UsersMessageSender::addStream() -- Sending [participants.shareWebcam] message to server with message [streamName:" + streamName + "]");
      ...
      logger.debug("UsersMessageSender::removeStream() -- Sending [participants.unshareWebcam] message to server");
      ...
      logger.debug("UsersMessageSender::queryForRecordingStatus() -- Sending [queryForRecordingStatus] message to server")
      ...
      logger.debug("UsersMessageSender::changeRecordingStatus() -- Sending [changeRecordingStatus] message to server with message [userId:" + userID + ", recording:" + recording + "]");
			var message:Object = new Object();
			message["userId"] = userID;
      ...
      logger.debug("UsersMessageSender::muteAllUsers() -- Sending [voice.muteAllUsers] message to server. mute=[" + mute + "]");
			var message:Object = new Object();
			message["mute"] = mute;
      ...
      logger.debug("UsersMessageSender::muteAllUsers() -- Sending [voice.muteAllUsersExceptPresenter] message to server. mute=[" + mute + "]");
			var message:Object = new Object();
			message["mute"] = mute;
      ...
      logger.debug("UsersMessageSender::muteUnmuteUser() -- Sending [voice.muteUnmuteUser] message to server with message [userId:" + userid + ", mute:" + mute + "]");
			var message:Object = new Object();
			message["userId"] = userid;
			message["mute"] = mute;
      ...
      logger.debug("UsersMessageSender::ejectUser() -- Sending [voice.kickUSer] message to server with message [userId:" + userid + "]");
			var message:Object = new Object();
			message["userId"] = userid;
      ...
      logger.debug("UsersMessageSender::getRoomMuteState() -- Sending [voice.isRoomMuted] message to server");
      ...
      logger.debug("UsersMessageSender::getRoomLockState() -- Sending [lock.isRoomLocked] message to server");
      ...
      logger.debug("UsersMessageSender::setAllUsersLock() -- Sending [setAllUsersLock] message to server");
		}
		
		public function setUserLock(internalUserID:String, lock:Boolean):void {
      logger.debug("UsersMessageSender::setUserLock() -- Sending [setUserLock] message to server - userId: [" + internalUserID + "] lock: [" + lock + "]");
			var message:Object = new Object();
      ...
      logger.debug("UsersMessageSender::getLockSettings() -- Sending [getLockSettings] message to server");
      ...
      logger.debug("UsersMessageSender::saveLockSettings() -- Sending [saveLockSettings] message to server");
      ...
      logger.debug("UsersMessageSender::validateToken() -- Sending [validateToken] message to server");
			var message:Object = new Object();
			message["userId"] = internalUserID;
