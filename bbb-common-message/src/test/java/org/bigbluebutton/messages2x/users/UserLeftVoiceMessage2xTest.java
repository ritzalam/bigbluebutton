...
import org.bigbluebutton.common.messages2x.users.UserLeftVoiceMessage2x;
import org.junit.Assert;
import org.junit.Test;

import java.util.ArrayList;

public class UserLeftVoiceMessage2xTest {

    @Test
    public void UserLeftVoiceMessage2x() {
        ...
        UserLeftVoiceMessage2x msg1 = new UserLeftVoiceMessage2x(voiceConf, user, meetingID);

        String json1 = msg1.toJson();

        // System.out.println(json1);

        UserLeftVoiceMessage2x msg2 = UserLeftVoiceMessage2x.fromJson(json1);

        Assert.assertEquals(UserLeftVoiceMessage2x.NAME, msg2.header.name);
