...
class RemovePresentationMessageHandlerTestSpec extends TestKit(ActorSystem("RemovePresentationMessage",
  ...
  "A MeetingActor" should {
    "Send a ?? when receiving RemovePresentationMessage" in { // TODO
      within(500 millis) {
        ...
        meetingActorRef ! du30RemovePresentationCommand
