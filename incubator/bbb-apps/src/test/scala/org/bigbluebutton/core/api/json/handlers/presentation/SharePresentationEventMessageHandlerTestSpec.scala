...
class SharePresentationEventMessageHandlerTestSpec extends TestKit(ActorSystem("SharePresentationEventMessage",
  ...
  "A MeetingActor" should {
    "Send a ?? when receiving SharePresentationEventMessage" in { // TODO
      within(500 millis) {
        ...
        meetingActorRef ! du30SharePresentationCommand
