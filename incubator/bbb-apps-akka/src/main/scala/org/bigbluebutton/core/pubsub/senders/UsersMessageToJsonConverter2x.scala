...
import org.bigbluebutton.core.api.OutGoingMessage.{ EndAndKickAll, PresenterAssigned, UserLeft, UserListeningOnly, _ }
import org.bigbluebutton.core.domain.{ Permissions, RegisteredUser2x, _ }
