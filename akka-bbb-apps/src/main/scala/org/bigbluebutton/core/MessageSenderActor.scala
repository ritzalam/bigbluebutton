...
class MessageSenderActor(val service: MessageSender)
  ...
  def receive = {
    ...
    case msg: org.bigbluebutton.core.api.PollStartedMessage => handlePollStartedMessage(msg)
    case msg: org.bigbluebutton.core.api.PollStoppedMessage => handlePollStoppedMessage(msg)
    case msg: org.bigbluebutton.core.api.PollShowResultMessage => handlePollShowResultMessage(msg)
    case msg: org.bigbluebutton.core.api.PollHideResultMessage => handlePollHideResultMessage(msg)
  ...
  private def handleUserEjectedFromMeeting(msg: UserEjectedFromMeeting) {
    ...
    service.send(ChannelConstants.FROM_USERS_CHANNEL, m.toJson)
  }
  ...
  private def handleDeskShareHangUp(msg: DeskShareHangUp) {
    ...
    service.send(ChannelConstants.TO_VOICE_CONF_SYSTEM_CHAN, json)
  }
  ...
  private def handleDeskShareNotifyViewersRTMP(msg: DeskShareNotifyViewersRTMP) {
    ...
    service.send(ChannelConstants.FROM_DESK_SHARE_CHANNEL, json)
  }
  ...
  private def handleGetChatHistoryReply(msg: GetChatHistoryReply) {
    ...
    service.send(ChannelConstants.FROM_CHAT_CHANNEL, json)
  }
  ...
  private def handleStartRecordingVoiceConf(msg: StartRecordingVoiceConf) {
    ...
    service.send(ChannelConstants.TO_VOICE_CONF_SYSTEM_CHAN, m.toJson())
  }
  ...
  private def handleMeetingDestroyed(msg: MeetingDestroyed) {
    ...
    service.send(ChannelConstants.FROM_MEETING_CHANNEL, json)
  }
  ...
  private def handleKeepAliveMessageReply(msg: KeepAliveMessageReply) {
    ...
    service.send(ChannelConstants.FROM_SYSTEM_CHANNEL, json)
  }
  ...
  private def handleMeetingEnded(msg: MeetingEnded) {
    ...
    service.send(ChannelConstants.FROM_USERS_CHANNEL, json2)
  }
  ...
  private def handleClearPresentationOutMsg(msg: ClearPresentationOutMsg) {
    ...
    service.send(ChannelConstants.FROM_PRESENTATION_CHANNEL, json)
  }
  ...
  private def handleRemovePresentationOutMsg(msg: RemovePresentationOutMsg) {
    ...
    service.send(ChannelConstants.FROM_PRESENTATION_CHANNEL, m.toJson())
  }
  ...
  private def handlePollStartedMessage(msg: org.bigbluebutton.core.api.PollStartedMessage) {
    val json = pollStartedMessageToJson(msg)
    service.send(ChannelConstants.FROM_POLLING_CHANNEL, json)
  }

  private def handlePollStoppedMessage(msg: org.bigbluebutton.core.api.PollStoppedMessage) {
    val json = pollStoppedMessageToJson(msg)
    service.send(ChannelConstants.FROM_POLLING_CHANNEL, json)
  }

  private def handlePollShowResultMessage(msg: org.bigbluebutton.core.api.PollShowResultMessage) {
    val json = pollShowResultMessageToJson(msg)
    service.send(ChannelConstants.FROM_POLLING_CHANNEL, json)
  }

  private def handlePollHideResultMessage(msg: org.bigbluebutton.core.api.PollHideResultMessage) {
  ...
  private def pollStartedMessageToJson(msg: org.bigbluebutton.core.api.PollStartedMessage): String = {
  ...
  private def pollStoppedMessageToJson(msg: org.bigbluebutton.core.api.PollStoppedMessage): String = {
  ...
  private def pollShowResultMessageToJson(msg: org.bigbluebutton.core.api.PollShowResultMessage): String = {
  ...
  private def pollHideResultMessageToJson(msg: org.bigbluebutton.core.api.PollHideResultMessage): String = {
  ...
  private def handleLockLayoutEvent(msg: LockLayoutEvent) {
    ...
    service.send(ChannelConstants.FROM_USERS_CHANNEL, evt.toJson())
  }
  ...
  private def handleGetCurrentLayoutReply(msg: GetCurrentLayoutReply) {
    ...
    service.send(ChannelConstants.FROM_USERS_CHANNEL, reply.toJson())
  }
  ...
  private def handleUserStatusChange(msg: UserStatusChange) {
    ...
    service.send(ChannelConstants.FROM_USERS_CHANNEL, json)
  }
  ...
  private def handleGetWhiteboardShapesReply(msg: GetWhiteboardShapesReply) {
    ...
    service.send(ChannelConstants.FROM_WHITEBOARD_CHANNEL, json)
  }
  ...
  private def handleSendCaptionHistoryReply(msg: SendCaptionHistoryReply) {
    ...
    service.send(ChannelConstants.FROM_CAPTION_CHANNEL, json)
  }
