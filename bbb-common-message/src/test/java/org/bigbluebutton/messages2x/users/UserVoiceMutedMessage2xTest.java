...
import org.bigbluebutton.common.messages2x.users.UserVoiceMutedMessage2x;
import org.junit.Assert;
import org.junit.Test;

import java.util.ArrayList;

public class UserVoiceMutedMessage2xTest {

    @Test
    public void UserVoiceMutedMessage2x() {
        ...
        UserVoiceMutedMessage2x msg1 = new UserVoiceMutedMessage2x(meetingID,
                user, voiceConf);
        ...
        UserVoiceMutedMessage2x msg2 = UserVoiceMutedMessage2x.fromJson(json1);

        Assert.assertEquals(UserVoiceMutedMessage2x.NAME, msg2.header.name);
