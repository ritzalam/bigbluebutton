...
import org.bigbluebutton.api.messaging.IStorageService;
...
public class MeetingService implements MessageListener {
  ...
  private void handleCreateMeeting(Meeting m) {
    ...
    if (m.isRecord()) {
      ...
      storageService.recordMeetingInfo(m.getInternalId(), metadata, breakoutMetadata);
    }
  ...
  public String addSubscription(String meetingId, String event,
                                String callbackURL) {
    String sid = storageService.storeSubscription(meetingId, event, callbackURL);
    return sid;
  }

  public boolean removeSubscription(String meetingId, String subscriptionId) {
    return storageService.removeSubscription(meetingId, subscriptionId);
  }

  public List<Map<String, String>> listSubscriptions(String meetingId) {
    return storageService.listSubscriptions(meetingId);
  }
  ...
  public void createdPolls1(String meetingId, String title, String question,
  ...
  public void setMessagingService2x(IMessagingService2x msgService2x) {
    this.msgService2x = msgService2x;
  }
