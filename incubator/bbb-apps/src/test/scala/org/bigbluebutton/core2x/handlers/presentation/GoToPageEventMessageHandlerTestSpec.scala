...
class GoToPageEventMessageHandlerTestSpec extends TestKit(ActorSystem("GoToPageEventMessage",
  ...
  "A MeetingActor" should {
    "Send a ?? when receiving GoToPageEventMessage" in { // TODO
      within(500 millis) {
        ...
        meetingActorRef ! du30GoToPageCommand
