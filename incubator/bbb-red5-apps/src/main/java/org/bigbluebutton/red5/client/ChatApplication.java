    ...
    public void handleChatMessage(String message) {
        ...
        if (obj.has("header") && obj.has("payload")) {
            ...
            if (header.has("name")) {
                ...
                if (SendPublicChatMessage.SEND_PUBLIC_CHAT_MESSAGE.equals(messageName)) {
                    ...
                    SendPublicChatMessage obj = new SendPublicChatMessage()

                } else if (SendPrivateChatMessage.SEND_PRIVATE_CHAT_MESSAGE.equals(messageName)) {

                } else if (GetChatHistoryReplyMessage.GET_CHAT_HISTORY_REPLY.equals(messageName)) {
