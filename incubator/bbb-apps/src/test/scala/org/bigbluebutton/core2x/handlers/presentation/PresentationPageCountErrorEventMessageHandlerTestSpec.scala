...
class PresentationPageCountErrorEventMessageHandlerTestSpec extends TestKit(ActorSystem
("PresentationPageCountErrorEventMessage",  ConfigFactory.parseString(TestKitUsageSpec.config)))
