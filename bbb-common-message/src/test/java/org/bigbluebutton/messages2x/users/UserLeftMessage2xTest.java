...
import org.bigbluebutton.common.messages2x.users.UserLeftMessage2x;
import org.junit.Assert;
import org.junit.Test;

import java.util.ArrayList;

public class UserLeftMessage2xTest {

    @Test
    public void UserLeftMessage2x() {
        ...
        UserLeftMessage2x msg1 = new UserLeftMessage2x(meetingID, user);

        String json1 = msg1.toJson();

        // System.out.println(json1);

        UserLeftMessage2x msg2 = UserLeftMessage2x.fromJson(json1);

        Assert.assertEquals(UserLeftMessage2x.NAME, msg2.header.name);
