...
import org.bigbluebutton.common.messages2x.users.UserJoinedVoiceMessage2x;
import org.junit.Assert;
import org.junit.Test;

import java.util.ArrayList;

public class UserJoinedVoiceMessage2xTest {

    @Test
    public void UserJoinedVoiceMessage2x() {
        ...
        UserJoinedVoiceMessage2x msg1 = new UserJoinedVoiceMessage2x(meetingID, voiceConf, user);

        String json1 = msg1.toJson();

        System.out.println(json1);

        UserJoinedVoiceMessage2x msg2 = UserJoinedVoiceMessage2x.fromJson(json1);

        Assert.assertEquals(UserJoinedVoiceMessage2x.NAME, msg2.header.name);
