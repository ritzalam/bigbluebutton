...
public class CreateMeetingApiMessage {
  ...
  public CreateMeetingApiMessage(String id, String externalId,
  ...
  public static CreateMeetingApiMessage fromJson(String json) {
    Gson gson = new Gson();
    CreateMeetingApiMessage msg = gson.fromJson(json, CreateMeetingApiMessage.class);
    return msg;
  }
}
