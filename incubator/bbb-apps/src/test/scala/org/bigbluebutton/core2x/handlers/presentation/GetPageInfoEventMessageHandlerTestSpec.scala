...
class GetPageInfoEventMessageHandlerTestSpec extends TestKit(ActorSystem("GetPageInfoEventMessage",
  ...
  "A MeetingActor" should {
    "Send a ?? when receiving GetPageInfoEventMessage" in { // TODO
      within(500 millis) {
        ...
        meetingActorRef ! du30GetPageInfoCommand
