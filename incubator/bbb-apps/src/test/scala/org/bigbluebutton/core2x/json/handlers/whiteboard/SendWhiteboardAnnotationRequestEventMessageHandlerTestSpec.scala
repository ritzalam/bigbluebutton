package org.bigbluebutton.core2x.json.handlers.presentation.whiteboard
...
class SendWhiteboardAnnotationRequestEventMessageHandlerTestSpec extends TestKit(ActorSystem("SendWhiteboardAnnotationRequestEventMessage",
  ...
  "A MeetingActor" should {
    "Send a ?? when receiving SendWhiteboardAnnotationRequestEventMessage" in { // TODO
      within(500 millis) {
